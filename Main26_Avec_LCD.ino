...
int Att = 4000; //Attente en millis seconde pour voir l'affichage
...
void loop() {
  ...
  switch (Mode) {
    ...
    case 1:
      ...
      if ( (EMG_On == 1) && (Pos == 0) && (Wait == 0)) { //((Etat == 3) ||
